...
<head>
    ...
    <link rel="stylesheet" type='text/css' href="<?=assets('/css2/build/concat/vr_ftl_inbox-v23643460724b.css', $home->app->cdn)?>">
    <link rel="stylesheet" type='text/css' href="<?=assets('/css2/build/concat/vr_inbox_rebrand-v2146956826b.css', $home->app->cdn)?>">
