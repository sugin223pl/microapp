        <div class="page ">
            <div class="react-container" id="component_1" data-component-props="page-manifest" data-component="common.page-router" data-component-init="data-component-init">
                <div class="trips-states-LoggedOutControlled__logged_out_container--1gNN8">
                    ...
                    <div class="trips-states-LoggedOutControlled__section_two--yicNl trips-states-LoggedOutControlled__page_image--2LWby trips-states-LoggedOutControlled__heart--1ldpO" style="background: transparent url('<?=assets('/img2/t4b/owners_redesign/marketing/image1.png', $home->app->cdn)?>') no-repeat 50%/cover;"></div>
                </div>
            </div>
        </div>
